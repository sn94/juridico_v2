...
<td class="text-center">  <a class="btn btn-danger btn-sm" href="<?=url("admin/clientes/pagos/".$cli->IDNRO)?>">Pagos</a></td>
 ...
 <td style="width: 100px;"> 
  ...
  <td class="text-center">
    <a  style="color: white;"  onclick="regenerarCredenciales(event)"  href="<?=url("admin/clientes/regenerar-password/".$cli->IDNRO)?>"> <i class="fa fa-key fa-lg"></i> </a>
  </td>
  <td class="text-center" >
  <a  style="color: white;"    href="<?= url("admin/clientes/update/".$cli->IDNRO) ?>"><i class="fa fa-pencil fa-lg" aria-hidden="true"></i></a>
  </td>


  <td class="text-center" >
  <a  style="color: white;" data-toggle="modal" data-target="#modal-eliminar"   href="<?= url("admin/clientes/delete/".$cli->IDNRO) ?>"><i class="fa fa-trash fa-lg" aria-hidden="true"></i></a>
  </td>
</tr>
