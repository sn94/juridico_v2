    ...
    <div class="app">
        <div class="app-body">
            ...
            <div class="app-content">
                <nav class="navbar navbar-expand navbar-light" style="background-color: #192c3e;"><button type="button" class="btn btn-sidebar" data-toggle="sidebar"><i class="fa fa-bars"></i></button>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <i class="fa fa-bell-o"></i></a>
                            ...
                            <div class="dropdown-menu dropdown-menu-right" style="background-color: #192c3e ;">
                ...
                <nav aria-label="breadcrumb"   >
                    <ol class="breadcrumb text-light" style="background-color: {{ isset($breadcrumbcolor)  ?  $breadcrumbcolor : '#192c3e;' }}">
                    @yield('breadcrumb')
