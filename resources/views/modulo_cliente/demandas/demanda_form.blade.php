...
<form onsubmit="enviarDemanda(event)" id="formDeman" class="tab-content" method="post" action="<?= $rutaEspecial ?>">
     ...
     <div class="row p-1">
          <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4   verde1">
               ...
               <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-lg-12 p-1">
                         ...
                         <div class="row">
                              <div class="col-12 col-sm-4 col-md-4"> <label for="actuaria">Cód. emp.:</label></div>
                              <div class="col-12 col-sm-8 col-md-8">
                              <input data-toggle="tooltip" data-placement="right" title="CÓDIGO EMPRESA" placeholder="CÓD. EMPRESA" name="COD_EMP" type="text" class="form-control form-control-sm" value="{{ !isset($ficha)? '' : $ficha->COD_EMP}}">
                              </div>
                         </div>
                         ...
                         <div class="row">
                              <div class="col-12 col-sm-4 col-md-4"> <label for="actuaria">Monto demanda:</label></div>
                              <div class="col-12 col-sm-8 col-md-8">
                              <input data-toggle="tooltip" data-placement="right" title="MONTO DEMANDA" placeholder="MONTO DEMANDA" name="DEMANDA" oninput="formatear(event)" type="text" class="form-control form-control-sm number-format" value="{{Helper::number_f( !isset($ficha)? '' : $ficha->DEMANDA)}}">
                         ...
                         <div class="row">
                              ...
                              <div class="col-12 col-sm-8 col-md-8">
                                   ...
                                   <input data-toggle="tooltip" data-placement="right" title="SALDO DEMANDA" readonly type="text" class="form-control form-control-sm number-format" value="{{Helper::number_f( !isset($ficha)? '' : $ficha->SALDO)}}">
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-lg-12">
                         ...
                         <input data-toggle="tooltip" data-placement="right" title="EXPEDIENTE N°" placeholder="EXPEDIENTE N°" maxlength="20" name="EXPED_NRO" type="text" class="form-control form-control-sm" value="{{ !isset($ficha)? '' : $ficha->EXPED_NRO}}">

                         <input data-toggle="tooltip" data-placement="right" title="FOLIO EXPEDIENTE" placeholder="FOLIO EXPEDIENTE" maxlength="20" name="FOLIO_EXPED" type="text" class="form-control form-control-sm" value="{{ !isset($ficha)? '' : $ficha->FOLIO_EXPED}}">
          ...
          <div class="col-12 col-sm-6 col-md-12 col-lg-4 col-xl-4 p-1 verde2">
               ...
               <input  data-toggle="tooltip" data-placement="right" title="EMBARGO N°" placeholder="EMBARGO N°" name="EMBARGO_NR" type="text" class="form-control form-control-sm" value="{{ !isset($ficha)? '' : $ficha->EMBARGO_NR}}">
             ...
             <input   data-toggle="tooltip" data-placement="right" title="CUENTA JUDICIAL N°" placeholder="N° CUENTA JUDICIAL" name="CTA_BANCO" type="text" class="form-control form-control-sm" value="{{ !isset($ficha)? '' : $ficha->CTA_BANCO}}">
...
<script>
     ...
     function limpiar_campos_dema() {
          $("#formDeman .number-format").each(function(indice, obj) {
               quitarSeparador(obj);
          });
     }
