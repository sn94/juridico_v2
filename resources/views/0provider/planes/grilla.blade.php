...
<table id="plancuenta" class="table table-striped  table-bordered   table-dark">
      ...
      <tbody>
        ...
        <tr> 
          <td>
            <a class="text-light" data-toggle="modal" data-target="#showform" onclick="editar(event)" href="<?=url("p/planes-servicio/M/".$it->IDNRO)?>"><i class="fa fa-pencil" aria-hidden="true"></i></a></td>
           
          <td>
            <a class="text-light"   onclick="prepararBorrar(event)" href="<?=url("p/planes-servicio-d/".$it->IDNRO)?>" ><i class="fa fa-trash" aria-hidden="true"></i></a></td>
