            ...
            <div class="app-sidebar sidebar-slide-left">
                ...
                <ul id="sidebar-nav" class="sidebar-nav">
                 ...
                 <li class="sidebar-nav-group">
                     <a href="<?=url("p/clientes")?>" class="sidebar-nav-link" ><i class="fa fa-users" aria-hidden="true"></i>
                        CLIENTES</a>
                      
                 </li>
                 <li class="sidebar-nav-group">
                     <a href="<?=url("p/usuarios")?>" class="sidebar-nav-link" ><i class="fa fa-users" aria-hidden="true"></i>
                        ADMINISTRADORES</a>
                 </li>

                 <li class="sidebar-nav-group">
                     <a href="<?=url("p/planes-servicio")?>" class="sidebar-nav-link" ><i class="fa fa-users" aria-hidden="true"></i>
                        PLANES</a>
                 </li>
                ...
                <a href="<?=url("signout/p")?>" data-toggle="tooltip" title="Logout"><i class="fa fa-power-off"></i></a></div>
