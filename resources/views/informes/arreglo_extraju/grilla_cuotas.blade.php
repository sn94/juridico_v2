...
<table id="informes_arreglo" class="table  table-sm table-bordered  table-striped" >
        <thead class="thead-dark">
            <tr> <th>CI</th><th>TITULAR</th><th class="text-right" >DEMANDA</th><th>DEMANDANTE</th>
             <th >COD. EMP</th><th>TIPO ARREG.</th><th>TOTAL</th><th>CUOTAS</th><th>CUO.PAGADAS</th> <th>IMPORTE</th><th>FECHA PAGO</th></tr>
        </thead>
        <tbody>
          ...
          <?php  foreach( $lista as $it):?>
            <tr style="font-size: 9pt;">
              ...
              <td  class="text-right"><p class="pt-1 mr-1 ml-1 mb-0">{{ $it->CI }}</p></td>
              ...
              <td class="text-right"> <p class="pt-1 mr-1 ml-1 mb-0">{{ Helper::beautyDate($it->FECHA_PAGO) }}</p> </td>
            </tr>
